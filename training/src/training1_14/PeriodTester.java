...
public class PeriodTester {
	...
	public static void main(String[] args) {
		...
		Period jeonggong = new Period(new Day(1398, 10, 14), new Day(1400, 11, 28)) ;
		Period taejong = new Period(new Day(1400, 11, 28), new Day(1418, 9, 9)) ;
		Period sejong = new Period(new Day(1418, 8, 5), new Day(1450, 3, 30)) ;
		
		System.out.println("태조 =" + taejo);
		System.out.println("정조 =" + jeonggong);
